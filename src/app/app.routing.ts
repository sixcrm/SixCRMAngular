...
const appRoutes: Routes = [
  ...
  { path : '', component : DefaultLayoutComponent, children : [
    ...
    { path : 'customer-service', loadChildren : './pages/customer-service-page/customer-service.module#CustomerServiceModule', canActivate: [AuthGuard, TermsAndConditionsGuard] },
