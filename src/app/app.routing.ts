...
const appRoutes: Routes = [
  ...
  { path : '', component : DefaultLayoutComponent, children : [
    ...
    { path : 'state-machine',
      loadChildren : './pages/state-machine-page/state-machine.module#StateMachineModule', canActivate: [AuthGuard, TermsAndConditionsGuard] },
    ...
    { path : 'customer-service-dashboard', loadChildren : './pages/customer-service-dashboard-page/customer-service-dashboard.module#CustomerServiceDashboardModule', canActivate: [AuthGuard, TermsAndConditionsGuard] },
